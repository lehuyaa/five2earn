...
//2
export const checkStatusMatchPendingAPI = async (params) => {
    return await request.get(`api/odt-on-outs`, { params });
};

//3
export const updateMatchStatusToCloseAPI = async (params) => {
...
//6
export const checkCompleteMatchAPI = async (params) => {
    return await request.get(`api/odt-on-outs`, { params });
};
